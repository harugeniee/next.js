  ...
  return (
    <div className={cn("space-y-6", className)}>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {t("contribute.review.summary", "series", {}, "Summary")}
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              {t(
                "contribute.review.fieldsChanged",
                "series",
                { count: changedFields.length },
                `${changedFields.length} field(s) will be updated`,
              )}
            </p>
      ...
      {changedFields.length > 0 && (
        <div className="space-y-2">
          <h3 className="text-lg font-semibold">
            {t(
              "contribute.review.changesPreview",
              "series",
              {},
              "Changes Preview",
            )}
        ...
        <Card className="border-destructive/50 bg-destructive/5">
          <CardContent className="pt-6">
            <div className="flex items-center gap-2 text-destructive">
              ...
              <p className="text-sm">
                {t(
                  "contribute.review.noChanges",
                  "series",
                  {},
                  "No changes detected. Please go back and make some updates.",
                )}
              </p>
            </div>
          </CardContent>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          placeholder={t(
            "contribute.review.contributorNotePlaceholder",
            "series",
          )}
          rows={4}
          maxLength={2000}
        ...
        <div className="flex justify-between text-xs text-muted-foreground">
          <span>
            {t(
              "contribute.review.noteHint",
              "series",
              {},
              "Optional: Explain your changes to help reviewers",
            )}
          </span>

      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>{t("organizations.list.title", "admin")}</CardTitle>
              <CardDescription>
                {t("organizations.list.description", "admin")}
              </CardDescription>
            </div>
            <Button size="sm" onClick={() => setShowCreateDialog(true)}>
              <Plus className="mr-2 h-4 w-4" />
              {t("organizations.list.create", "admin")}
            </Button>
          </div>
        </CardHeader>
        <CardContent>
              ...
              <div className="rounded-md border">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead>
                        {t("organizations.fields.organization", "admin")}
                      </TableHead>
                      <TableHead>
                        {t("organizations.fields.owner", "admin")}
                      </TableHead>
                      <TableHead>
                        {t("organizations.fields.visibility", "admin")}
                      </TableHead>
                      <TableHead>
                        {t("organizations.fields.status", "admin")}
                      </TableHead>
                      <TableHead>
                        {t("organizations.fields.members", "admin")}
                      </TableHead>
                      <TableHead>
                        {t("organizations.fields.articles", "admin")}
                      </TableHead>
                      ...
                      >
                          ...
                          {organization.owner ? (
                            <div className="flex items-center gap-2">
                              <Avatar className="h-6 w-6">
                                <AvatarImage
                                  src={
                                    organization.owner.avatar?.url || undefined
                                  }
                        ...
                        <TableCell>
                          <Badge variant="outline">
                            {t(
                              `organizations.visibility.${organization.visibility}`,
                              "admin",
                            )}
                          </Badge>
                        </TableCell>

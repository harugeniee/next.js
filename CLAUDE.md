...
# CLAUDE.md — Next.js 16+ Frontend-Only Project

## Project Overview

A **Next.js 16+ frontend-only application** for a manga/anime content platform (MangaSBS).
All pages are client components wrapped in `NoSSR`. No server actions or API routes.

> **Detailed rules**: See `.cursor/rules/*.mdc` files for comprehensive documentation.

---

## AI Assistant Guidelines

You are a Senior Front-End Developer expert in React 19, Next.js 16, TypeScript 5, TailwindCSS 4, shadcn/ui, and Radix UI.
